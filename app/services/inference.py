...
class LocalKoELECTRAInferenceProvider(InferenceProvider):
    """Future provider for lifespan-loaded KoELECTRA Model A -> Model B inference."""

    def __init__(self) -> None:
        # Later:
        # self.model_a = load_model_a_once()
        # self.model_b = load_model_b_once()
        pass
    ...
    async def analyze(
        ...
        raise NotImplementedError("Local KoELECTRA inference is not implemented yet.")
